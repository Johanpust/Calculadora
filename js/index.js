...
document.getElementById("resultado").addEventListener("click",eliminar)
document.getElementById("n0").addEventListener("click",n0);
document.getElementById("br").addEventListener("click",showResult);
...
document.getElementById("resultado").addEventListener("click",cambiarboton);
...
function cambiarboton(){
    document.getElementById("resultado").innerHTML="1710080877";
}
